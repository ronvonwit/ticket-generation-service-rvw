...
export interface CompleteFn<WorkerOutputVariables> {
     ...
     */
    success: (updatedVariables?: WorkerOutputVariables) => Promise<JOB_ACTION_ACKNOWLEDGEMENT>;
    /**
     ...
     */
    failure: (errorMessage: string, retries?: number) => Promise<JOB_ACTION_ACKNOWLEDGEMENT>;
    /**
...
export interface JobCompletionInterface<WorkerOutputVariables> {
     ...
     * count is decremented. Pass in `0`for retries to raise an incident in Operate.
     */
    fail: (errorMessage: string, retries?: number) => Promise<JOB_ACTION_ACKNOWLEDGEMENT>;
    /**
     * Mark this job as forwarded to another system for completion. No action is taken by the broker.
     * This method releases worker capacity to handle another job.
     */
...
export declare type ZBWorkerTaskHandler<WorkerInputVariables = IInputVariables, CustomHeaderShape = ICustomHeaders, WorkerOutputVariables = IOutputVariables> = (job: Readonly<ZeebeJob<WorkerInputVariables, CustomHeaderShape, WorkerOutputVariables>>, 
/**
 * @deprecated use the methods on the job object insteaad
 */
complete: CompleteFn<WorkerOutputVariables>, worker: ZBWorker<WorkerInputVariables, CustomHeaderShape, WorkerOutputVariables>) => MustReturnJobActionAcknowledgement;
...
export declare type BatchedJob<Variables = IInputVariables, Headers = ICustomHeaders, Output = IOutputVariables> = Job<Variables, Headers> & CompleteFn<Output> & JobCompletionInterface<Output>;
